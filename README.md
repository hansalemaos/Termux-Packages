...
| **nushell** | 0.94.1 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **oh-my-posh** | 21.1.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
