...
| **apt** | 2.7.12-2 | Front-end for the dpkg package manager | https://packages.debian.org/apt |
| **apt-file** | 3.3 | search for files within packages | https://wiki.debian.org/apt-file |
| **apt-ftparchive** | 2.7.12-2 | apt-ftparchive is the command line tool that generates the index files that APT uses to access a distribution source | https://packages.debian.org/apt |
| **apt-transport-tor** | 2.7.12-2 | APT transport for anonymous package downloads via Tor | https://packages.debian.org/apt |
...
| **caddy** | 2.8.1 | Fast, cross-platform HTTP/2 web server | https://caddyserver.com/ |
...
| **chezmoi** | 2.48.2 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **cloudflared** | 2024.5.0 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **cmake** | 3.29.3 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 3.29.3 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **command-not-found** | 2.4.0-26 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **crowbook** | 0.16.1-1 | Allows you to write a book in Markdown without worrying about formatting or typography | https://github.com/lise-henry |
...
| **duckdb** | 0.10.3 | DuckDB Command Line Interface (CLI) shell | https://duckdb.org/ |
...
| **gojq** | 0.12.15 | Pure Go implementation of jq | https://github.com/itchyny/gojq |
...
| **hz** | 0.9.0 | A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices | https://www.cloudwego.io |
...
| **jfrog-cli** | 2.57.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **lgogdownloader** | 3.13 | Open source downloader to GOG.com for Linux users using the same API as the official GOGDownloader | https://sites.google.com/site/gogdownloader/ |
...
| **libc++utilities** | 5.24.8 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **libdav1d** | 1.4.2 | AV1 cross-platform decoder focused on speed and correctness | https://code.videolan.org/videolan/dav1d/ |
...
| **libduckdb** | 0.10.3 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 0.10.3 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libgrpc** | 1.64.1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libiniparser** | 4.2.2 | Offers parsing of ini files from the C level | https://github.com/ndevilla/iniparser |
| **libiniparser-static** | 4.2.2 | Static libraries for libiniparser | https://github.com/ndevilla/iniparser |
...
| **libnghttp3** | 1.3.0 | HTTP/3 library written in C | https://nghttp2.org/nghttp3/ |
| **libnghttp3-static** | 1.3.0 | Static libraries for libnghttp3 | https://nghttp2.org/nghttp3/ |
...
| **libopenmpt** | 0.7.7 | OpenMPT based module player library and libopenmpt based command-line player | https://lib.openmpt.org/libopenmpt/ |
| **libopenmpt-static** | 0.7.7 | Static libraries for libopenmpt | https://lib.openmpt.org/libopenmpt/ |
...
| **libxml2** | 2.12.7 | Library for parsing XML documents | http://www.xmlsoft.org |
| **libxml2-python** | 2.12.7 | Python bindings for libxml2 | http://www.xmlsoft.org |
| **libxml2-python-static** | 2.12.7 | Static libraries for libxml2-python | http://www.xmlsoft.org |
| **libxml2-static** | 2.12.7 | Static libraries for libxml2 | http://www.xmlsoft.org |
| **libxml2-utils** | 2.12.7 | XML utilities | http://www.xmlsoft.org |
...
| **lua-language-server** | 3.9.1 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **mautrix-whatsapp** | 0.10.7 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
| **maven** | 3.9.7 | A Java software project management and comprehension tool | https://maven.apache.org/ |
...
| **minio** | 2024.05.28.17.19.04 | Multi-Cloud Object Storage | https://min.io/ |
...
| **minizinc** | 2.8.4 | A medium-level constraint modelling language | https://github.com/MiniZinc/libminizinc |
| **minizinc-static** | 2.8.4 | Static libraries for minizinc | https://github.com/MiniZinc/libminizinc |
...
| **mupdf** | 1.24.2-1 | Lightweight PDF and XPS viewer (library) | https://mupdf.com/ |
| **mupdf-static** | 1.24.2-1 | Static libraries for mupdf | https://mupdf.com/ |
| **mupdf-tools** | 1.24.2-1 | Lightweight PDF and XPS viewer (utilities) | https://mupdf.com/ |
...
| **nala** | 0.15.2 | Commandline frontend for the apt package manager | https://gitlab.com/volian/nala |
...
| **neovim** | 0.9.5-1 | Ambitious Vim-fork focused on extensibility and agility (nvim) | https://neovim.io/ |
...
| **nushell** | 0.93.0 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **oh-my-posh** | 21.0.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **php** | 8.3.7 | Server-side, HTML-embedded scripting language | https://php.net |
| **php-apache** | 8.3.7 | Apache 2.0 Handler module for PHP | https://php.net |
| **php-apache-ldap** | 8.3.7 | LDAP module for PHP/Apache | https://php.net |
| **php-apache-opcache** | 8.3.7 | OPcache module for PHP/Apache | https://php.net |
| **php-apache-pgsql** | 8.3.7 | PostgreSQL modules for PHP/Apache | https://php.net |
| **php-apache-sodium** | 8.3.7 | Sodium module for PHP/Apache | https://php.net |
| **php-apcu** | 5.1.23-2 | APCu - APC User Cache | http://php.net/apcu |
| **php-fpm** | 8.3.7 | FastCGI Process Manager for PHP | https://php.net |
| **php-imagick** | 3.7.0-4 | The Imagick PHP extension | https://github.com/Imagick/imagick |
| **php-ldap** | 8.3.7 | LDAP module for PHP | https://php.net |
| **php-pgsql** | 8.3.7 | PostgreSQL modules for PHP | https://php.net |
...
| **php-sodium** | 8.3.7 | Sodium module for PHP | https://php.net |
...
| **proot** | 5.1.107-64 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
| **proot-distro** | 4.13.0-1 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **pv** | 1.8.9 | Terminal-based tool for monitoring the progress of data through a pipeline | http://www.ivarch.com/programs/pv.shtml |
...
| **python** | 3.11.9-1 | Python 3 programming language intended to enable clear programs | https://python.org/ |
| **python-apsw** | 3.46.0.0 | Another Python SQLite Wrapper | https://github.com/rogerbinns/apsw/ |
...
| **python-cryptography** | 42.0.7 | Provides cryptographic recipes and primitives to Python developers | https://github.com/pyca/cryptography |
| **python-ensurepip-wheels** | 3.11.9-1 | Wheels for Python ensurepip | https://python.org/ |
...
| **python-grpcio** | 1.64.1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-static** | 3.11.9-1 | Static libraries for python | https://python.org/ |
| **python-tkinter** | 3.11.9-1 | Tkinter support for Python 3 | https://python.org/ |
...
| **railway-cli** | 3.7.0 | This is the command line interface for Railway | https://railway.app |
...
| **ruff** | 0.4.7 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust** | 1.78.0-1 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
| **rust-analyzer** | 20240527 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **rust-docs** | 1.78.0-1 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.78.0-1 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.78.0-1 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.78.0-1 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.78.0-1 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.78.0-1 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasi** | 1.78.0-1 | Rust std for target wasm32-wasi | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.78.0-1 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.78.0-1 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.78.0-1 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **squid** | 6.9 | Full-featured Web proxy cache server | http://www.squid-cache.org |
...
| **step-cli** | 0.26.1-1 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **swift-runtime-aarch64** | 5.10-2 | Swift runtime libraries for Android AArch64 | https://swift.org/ |
| **swift-runtime-arm** | 5.10-2 | Swift runtime libraries for Android armv7 | https://swift.org/ |
| **swift-runtime-x86-64** | 5.10-2 | Swift runtime libraries for Android x86_64 | https://swift.org/ |
| **swift-sdk-aarch64** | 5.10-2 | Swift SDK for Android AArch64 | https://swift.org/ |
| **swift-sdk-arm** | 5.10-2 | Swift SDK for Android armv7 | https://swift.org/ |
| **swift-sdk-x86-64** | 5.10-2 | Swift SDK for Android x86_64 | https://swift.org/ |
...
| **taskwarrior** | 3.0.2 | Utility for managing your TODO list | https://taskwarrior.org |
...
| **tcsh** | 6.24.12 | TENEX C Shell, an enhanced version of Berkeley csh | https://www.tcsh.org |
...
| **telegram-bot-api** | 20240514 | Telegram Bot API server | https://github.com/tdlib/telegram-bot-api |
| **telegram-cli** | 1:1.4.1-6 | Telegram messenger CLI | https://github.com/vysheng/tg |
| **teleport-tsh** | 15.4.0 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **ttyplot** | 1.6.4 | A realtime plotting utility for terminal with data input from stdin | https://github.com/tenox7/ttyplot |
...
| **ugrep** | 6.0.0 | A faster, user-friendly and compatible grep replacement | https://github.com/Genivia/ugrep |
...
| **usql** | 0.19.1 | A universal command-line interface for SQL databases | https://github.com/xo/usql |
...
| **vale** | 3.4.2 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **vim** | 9.1.0200 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vis** | 0.9 | Modern, legacy free, simple yet efficient vim-like editor | https://www.brain-dump.org/projects/vis/ |
...
| **weechat** | 4.3.0 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.3.0 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.3.0 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.3.0 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.3.0 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **xz-utils** | 5.6.1+really5.4.5 | XZ-format compression tools | https://xz.tukaani.org/xz-utils/ |
...
| **zig** | 0.12.0 | General-purpose programming language and toolchain | https://ziglang.org |
...
| **zrok** | 0.4.30-1 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
